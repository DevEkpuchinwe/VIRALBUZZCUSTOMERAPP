...
import 'package:cabbieuser/data/controller/reference/reference_contrller.dart';
import 'package:cabbieuser/data/repo/refer/reference_repo.dart';
...
class _ReferralAFriendsScreenState extends State<ReferralAFriendsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
          title: MyStrings.referralAFriends.toCapitalized(), elevation: 3),
                  ...
                  children: [
                    const Padding(
                        padding: EdgeInsetsDirectional.only(
                            start: Dimensions.space10, end: Dimensions.space20),
                      ...
                      children: [
                        Padding(
                          ...
                          child: DottedBorder(
                            ...
                            radius:
                                const Radius.circular(Dimensions.mediumRadius),
                            child: Container(
                              decoration: BoxDecoration(
