...
import 'package:cabbieuser/data/controller/support/support_controller.dart';
...
import 'package:cabbieuser/presentation/components/floating_action_button/fab.dart';
import 'package:cabbieuser/presentation/components/no_data.dart';
import 'package:cabbieuser/presentation/components/shimmer/ticket_card_shimmer.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SupportController>(builder: (controller) {
      return Scaffold(
        ...
        appBar:
            CustomAppBar(title: MyStrings.supportTicket, isTitleCenter: true),
