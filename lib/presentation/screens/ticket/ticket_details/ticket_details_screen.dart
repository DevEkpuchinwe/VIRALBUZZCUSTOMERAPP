...
import 'package:cabbieuser/data/controller/support/ticket_details_controller.dart';
import 'package:cabbieuser/data/repo/support/support_repo.dart';
...
import 'package:cabbieuser/presentation/components/buttons/custom_circle_animated_button.dart';
...
import 'package:cabbieuser/presentation/components/dialog/app_dialog.dart';
...
import 'package:cabbieuser/presentation/components/text/label_text.dart';
import 'package:cabbieuser/presentation/screens/ticket/ticket_details/widget/attachment_preview.dart';
import 'package:cabbieuser/presentation/screens/ticket/ticket_details/widget/ticket_meassge_widget.dart';
                              ...
                              CustomCircleAnimatedButton(
                                onTap: () {
                                  ...
                                  AppDialog().warningAlertDialog(context,
                                      msgText: MyStrings
                                          .closeTicketWarningTxt.tr, () {
                                    Get.back();
                                    controller.closeTicket(controller
                                            .model.data?.myTickets?.id
                                            .toString() ??
                                        '-1');
                                    Get.back();
                                  });
                                    ...
                                    Row(
                                      children: List.generate(
                                        ...
                                        (index) => AttachmentPreviewWidget(
                                          ...
                                          isFileImg: MyUtils.isImage(controller
