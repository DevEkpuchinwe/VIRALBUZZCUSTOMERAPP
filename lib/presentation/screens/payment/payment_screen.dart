...
import 'package:cabbieuser/core/utils/app_status.dart';
...
import 'package:cabbieuser/data/controller/coupon/coupon_controller.dart';
import 'package:cabbieuser/data/controller/payment/ride_payment_controller.dart';
import 'package:cabbieuser/data/model/global/app/ride_model.dart';
import 'package:cabbieuser/data/repo/coupon/coupon_repo.dart';
import 'package:cabbieuser/data/repo/payment/payment_repo.dart';
...
import 'package:cabbieuser/presentation/components/bottom-sheet/custom_bottom_sheet.dart';
import 'package:cabbieuser/presentation/components/buttons/rounded_button.dart';
import 'package:cabbieuser/presentation/components/divider/custom_divider.dart';
import 'package:cabbieuser/presentation/components/image/my_network_image_widget.dart';
import 'package:cabbieuser/presentation/screens/coupon/widget/coupon_widget.dart';
import 'package:cabbieuser/presentation/screens/payment/widget/payment_bottom_sheet.dart';
import 'package:cabbieuser/presentation/screens/payment/widget/payment_ride_details_card.dart';
                  ...
                  builder: (couponController) {
                    return Column(
                      ...
                      children: [
                        ...
                        const CustomDivider(
                            color: MyColor.rideSub, space: Dimensions.space10),
                        summaryRow(
                        ...
                        summaryRow(
                          ...
                          amount:
                              "${controller.defaultCurrencySymbol}${Converter.calculateDiscount(controller.ride.amount ?? '0', couponController.selectedCoupon.amount ?? '0', isPercentageCalculation: couponController.selectedCoupon.discountType == AppStatus.DISCOUNT_PERCENT)}",
                          isTitleBold: true,
                        ),
