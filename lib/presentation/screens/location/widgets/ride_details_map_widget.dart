...
import 'package:cabbieuser/presentation/components/buttons/icon_button.dart';
import 'package:cabbieuser/presentation/components/buttons/rounded_button.dart';
import 'package:cabbieuser/presentation/components/column_widget/card_column.dart';
import 'package:cabbieuser/presentation/packages/simple_ripple_animation.dart';
import 'package:cabbieuser/presentation/screens/location/widgets/driver_profile_widget.dart';
import 'package:cabbieuser/presentation/screens/location/widgets/driver_searching_widget.dart';
import 'package:cabbieuser/presentation/screens/location/widgets/ride_cancel_bottom_sheet_body.dart';
import 'package:cabbieuser/presentation/screens/location/widgets/ride_details_review_bottom_sheet.dart';
import 'package:cabbieuser/presentation/screens/location/widgets/ride_otp_widget.dart';
import 'package:cabbieuser/presentation/screens/location/widgets/ride_sos_bottom_sheet_body.dart';
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                            child: CustomIconButton(
                              ...
                              isSvg: true,
                              bgColor: (ride.status != AppStatus.RIDE_RUNNING &&
                      ...
                      if (ride.status == AppStatus.RIDE_ACTIVE ||
                        ...
                        Container(
                          ...
                          child: Center(
                              child: Text(MyStrings.rideCompleted.tr,
                                  style: boldDefault.copyWith(
                                      color: MyColor.greenSuccessColor))),
                        )
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  ...
                                  width: 1)),
                          child: Center(
                            child: Text(MyStrings.rideCanceled.tr,
                                style: boldDefault.copyWith(
                                    color: MyUtils.getRideStatusColor(
                                        AppStatus.RIDE_CANCELED))),
                          ),
