...
import 'package:cabbieuser/core/utils/debouncer.dart';
...
import 'package:cabbieuser/presentation/components/text-form-field/location_pick_text_field.dart';
                          ...
                          markers: <Marker>{
                            if (showMarker)
                              Marker(
                                ...
                                position: LatLng(controller.selectedLatitude,
                                    controller.selectedLongitude),
                                infoWindow: const InfoWindow(
                                    title: MyStrings.myLocation),
                                icon: bytes == null
                ...
                Positioned(
                  ...
                  child: FloatingActionButton(
                    ...
                    child: const Icon(Icons.location_searching,
                        color: MyColor.colorWhite, size: Dimensions.space30),
                    onPressed: () async {
