...
import 'package:cabbieuser/presentation/screens/inter_city/widget/intercity_offer_rate_widget.dart';
import 'package:cabbieuser/presentation/screens/inter_city/widget/intercity_payment_methods.dart';
...
import 'package:cabbieuser/data/controller/inter_city/inter_city_controller.dart';
                      ...
                      child: IntrinsicHeight(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: controller.appServices[index].id ==
                                    controller.selectedService.id
                                ? Border.all(
                          ...
                          child: FittedBox(
                            child: Column(
                              ...
                              children: [
                                MyImageWidget(
                                  imageUrl:
                                      controller.appServices[index].image ?? '',
                                  height: 60,
                                  width: 60,
                                  radius: 10,
                                ),
            ...
            child: Column(
              ...
              children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      MyStrings.recommendPrice.rKv({
                        "priceKey":
                            "${controller.defaultCurrencySymbol}${Converter.formatNumber(controller.rideFare.minAmount.toString())}",
                        "distanceKey":
                ...
                CustomTextField(
                  ...
                  labelText: '',
                  hintText:
                      DateConverter.formatDate(controller.selectedDateTime),
                          ...
                          children: [
                            Text(
                              controller.mainAmount == 0
                                  ...
                                  : '${controller.mainAmount} ${controller.defaultCurrency}',
                              style: regularDefault.copyWith(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(
                              controller.selectedPaymentMethod.id == '-99'
                ...
                RoundedButton(
                  ...
                  press: () {
                    if (controller.isValidForNewRide()) {
                      ...
                      CustomSnackBar.error(
                          errorList: [MyStrings.pleaseFillUpAllOfTheFields]);
                    }
                  },
                  isOutlined: false,
                ),
